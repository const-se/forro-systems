            ...
            'radiators' => array(
                array(
                    ...
                    'description' => 'Наборная конструкция состоит из секций разной высоты, что позволяет подобрать оптимальную тепловую мощность и заменить требующие ремонта части.
                     Выдерживают давление до 18 атмосфер и температуру до 130 градусов',
                ),
                array(
                ...
                array(
                    ...
                    'caption' => 'Стальной трубчатый радиатор',
                    'description' => 'Поверхность радиаторов проходит 5 стадий обработки: 2 стадии очистки, грунтовка, окраска порошковой эмалью в электростатическом поле, тепловая и антистатическая обработка',
                ),
                array(
                ...
                array(
                    ...
                    'description' => 'Чугунные радиаторы долговечны, срок их службы может доходить до 35 лет и более.
                ...
                array(
                    ...
                    'description' => 'Нагревшиеся радиаторы не остывают долгое время, обогревая воздух за счет теплового излучения.
                     Выдерживают мощные нагрузки до 10 отмосфер с максимальным температурным режимом 150 градусов',
                ),
            ),
        ),
    ),
