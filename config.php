...
$content = array(
        ...
        'slider' => array(
            'convectors' => array(
                array(
                    ...
                    'description' => 'Благодаря современному дизайну, конвекторы отлично смотрятся в любом современном интерьере',
                ),
                array(
                    'image' => 'convector-2.jpg',
                    'caption' => 'Напольный конвектор',
                    'description' => 'Конвекторы работают по принципу циркуляции, равномерно прогревая и не пересушивая воздух,
                     а еще минимизируя перепад температуры',
                ),
                array(
                    'image' => 'convector-3.jpg',
                    'caption' => 'Напольный конвектор',
                    'description' => 'Максимальная разница температуры у пола и потолка 2 градуса. А еще с конвектором можно не беспокоиться о пожаре',
                ),
                array(
                    'image' => 'convector-4.jpg',
                    'caption' => 'Настенный конвектор',
                    'description' => 'Нельзя не отметить такие достоинства конвекторов, как наличие терморегуляторов и защиты от перегрева',
                ),
                array(
                ...
                array(
                    ...
                    'description' => 'Благодаря расположению в полу такие конвекторы не занимают места в комнате и практически незаметны',
                ),
                array(
            ...
            'radiators' => array(
                array(
                    ...
                    'description' => 'Наборная конструкция состоит из секций разной высоты, что позволяет подобрать оптимальную тепловую мощность и заменить требующие ремонта части.
                     Выдерживают давление до восемнадцати атмосфер и температуру до ста тридцати градусов',
                ),
                array(
                    'image' => 'radiator-2.jpg',
                    'caption' => 'Алюминиевый радиатор',
                    'description' => 'Легкие радиаторы универсальны, подходят для стандартных условий установки, имеют интересный внешний вид, не требующий окраски',
                ),
                array(
                    'image' => 'radiator-3.jpg',
                    'caption' => 'Алюминиевый радиатор',
                    'description' => 'Алюминиевые радиаторы мало нуждаются в промывке благодаря внутренней гладкой поверхности.
                     Специальное покрытие предохраняет их от различных повреждений',
                ),
                array(
                    'image' => 'radiator-4.jpg',
                    'caption' => 'Стальной трубчатый радиатор',
                    'description' => 'Монтаж трубчатых радиаторов отопления очень прост, так как они имеют сварную конструкцию и полностью готовы к установке',
                ),
                array(
                    'image' => 'radiator-5.jpg',
                    'caption' => 'Стальной трубчатый радиатор',
                    'description' => 'Поверхность радиаторов проходит пять стадий обработки: две стадии очистки, грунтовка, окраска порошковой эмалью в электростатическом поле, тепловая и антистатическая обработка',
                ),
                array(
                    'image' => 'radiator-6.jpg',
                    'caption' => 'Стальной трубчатый радиатор',
                    'description' => 'Современные технологии лазерной сварки и опрессовочные испытания гарантируют заявленные характеристики радиатора. Они не имеют ограничений по геометрическим параметрам и размерам',
                ),
                array(
                    'image' => 'radiator-7.jpg',
                    'caption' => 'Чугунный радиатор',
                    'description' => 'Чугунные радиаторы долговечны, срок их службы может доходить до тридцати пяти лет и более.
                     Характеризуются высоким уровнем прочности, устойчивостью к коррозии, им не страшны скачки давления и внешние повреждения',
                ),
                array(
                    'image' => 'radiator-8.jpg',
                    'caption' => 'Чугунный радиатор',
                    'description' => 'Чугунные радиаторы успешно используются более века. Модели невзрачного внешнего вида,
                     требующие постоянной окраски, остались в прошлом. Сейчас рынок наполнен современными дизайнерскими решениями',
                ),
                array(
                    'image' => 'radiator-9.jpg',
                    'caption' => 'Чугунный радиатор',
                    'description' => 'Нагревшиеся радиаторы не остывают долгое время, обогревая воздух за счет теплового излучения.
                     Выдерживают мощные нагрузки до десяти отмосфер с максимальным температурным режимом сто пятьдесят градусов',
                ),
            ),
        ),
    ),
    ...
    'feedback' => array(
        ...
        'slider' => array(
            ...
            array(
                'image' => 'review4.png',
                'text_short' => 'Огромное спасибо ребятам из ФОРРО Системс за помощь в подборе радиатора, быстрый и качественный монтаж!',
                'text_full' => array(
                    'Недавно делали ремонт у родителей в спальной и сменили старые радиаторы на новые - биметаллические, 10 секций. По сравнению со старыми батареями, эти греют вдвойне теплее, направляя воздух своими изгибами вперед, то есть в комнату, а не рассеивая его сзади. В целом, радиатором очень довольны, греет очень хорошо!',
                    'Огромное спасибо ребятам из ФОРРО Системс за помощь в подборе радиатора, быстрый и качественный монтаж! Уже думаем поставить радиатор в зале, но уже 13 секций, так как комната побольше, и мы уже знаем, к кому обратимся.',
                ),
                'name' => 'Константин, г. Владимир',
            ),
            array(
                'image' => 'review2.jpg',
    ...
    'about' => array(
        ...
        'text' => array(
            'Forro Systems — молодая, динамично развивающаяся компания, которая является единственным во Владимирской области
             официальным дистрибьютором ведущих российских и зарубежных производителей водяных конвекторов и элитных радиаторов
             отопления. Мы не только предлагаем широкий ассортимент отопительных приборов, но и осуществляем их монтаж, гарантийное
             и послегарантийное обслуживание. ',
            'Нашим клиентам мы готовы предложить радиаторы от эконом класса (алюминий, биметалл) до элитных отопительных приборов.
             Трубчатые радиаторы, дизайн - и ретро - радиаторы, чугунные радиаторы таких ведущих мировых производителей,
             как IRSAP Tesi, Arbonia, Zehnder, Guratec, EXEMET, RETROstyle.',
            'Ждем Вас по адресу: г. Владимир, ул. Чайковского д. 21А, офис 22.',
        ),
    ),
    'map' => array(
        'icon_text' => 'Ждем Вас!',
        'text' => '<strong>г. Владимир, ул. Чайковского д. 21А, офис 22</strong>',
